...
export function Bell(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base} {...props}>
      <path d="M6 8a6 6 0 1 1 12 0v5l1.5 3h-15L6 13V8zM10 19a2 2 0 0 0 4 0" />
    </svg>
  );
}

export function StickyNote(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base} {...props}>
      <path d="M4 4h12l4 4v12H4zM16 4v4h4M8 12h6M8 16h4" />
    </svg>
  );
}
...
export function Pin(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base} {...props}>
      <path d="M9 4h6l-1 6 4 4H6l4-4-1-6zM12 14v6" />
    </svg>
  );
}
